...
class Settings(BaseSettings):
    ...
    def parse_allowed_origins(cls, v):
        """Accept JSON arrays, wildcard, and comma-separated strings from env."""
        ...
        if isinstance(v, str):
            ...
            # Try JSON first for values like ["https://app.example.com"].
            if value.startswith("["):
                try:
            ...
            # Support ALLOWED_ORIGINS=* and comma-separated values.
            if value == "*":
                return ["*"]
